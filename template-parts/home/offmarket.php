...
?>
<section class="wpis-section bg-text-strong text-surface">
	<div class="wpis-container-wide">
		<div class="grid items-center gap-12 lg:grid-cols-[1.4fr_1fr]">
			<div>
				...
				<h2 class="font-display text-4xl leading-[1.05] text-surface md:text-5xl">
				...
				<p class="mt-6 max-w-xl font-body text-base leading-relaxed text-surface/70">
			...
			<div class="lg:justify-self-end">
				<a href="mailto:<?php echo esc_attr( get_option( 'admin_email' ) ); ?>?subject=<?php echo esc_attr( rawurlencode( __( 'Accès aux biens off-market', 'hello-immosync' ) ) ); ?>"
					class="inline-flex items-center justify-center gap-2 rounded-[var(--radius-card)] bg-surface px-8 py-4 font-body text-sm font-medium uppercase tracking-[0.12em] text-text-strong transition-colors hover:bg-brand hover:text-surface">
